...
const translations = {
  tr: {
    ...
    searchTeamByName: "İsimle takım ara...",
    typeToSearch: "Takım adı yazın...",
    minThreeChars: "En az 3 karakter yazın",
    searching: "Aranıyor...",
    teamNotFound: "Takım bulunamadı",
    orSearchDirectly: "veya doğrudan arayın",
    compare: "Karşılaştır",
  ...
  en: {
    ...
    typeToSearch: "Type team name...",
    minThreeChars: "Type at least 3 characters",
    searching: "Searching...",
